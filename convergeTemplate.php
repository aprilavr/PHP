<?php
  ...
  $merchantID = "";//Converge 6-Digit Account ID *Not the 10-Digit Elavon Merchant ID*
  $merchantUserID = "";//Converge User ID *MUST FLAG AS HOSTED API USER IN CONVERGE UI*
  $merchantPIN = "";//Converge PIN (64 CHAR A/N)
  ...
  $amount= $_POST['total']; //Capture amount as POST data from cart //Hard-coded transaction amount for testing.
